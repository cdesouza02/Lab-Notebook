...
- [ ] edit and submit CERF rising tides application
- [ ] Gilman application
- [ ] COP30 application
...
- [x] pool samples (mon)
	- 30 ng or 20 ng?
- [ ] Gel extraction protocol w/ Nikea (tues/thurs)
	- dont do two rows, run it slowly
- [ ] 9am undergrad interview (wed)
- [ ] coral study (wed)
- [ ] edit Q1&2 rising tides (wed)
- [x] **SDP for Belize**
	- [x] **concur for belize**
- [ ] 10am undergrad interview (thurs)
- [ ] **Fulbright meeting with Nikea** (thurs)
