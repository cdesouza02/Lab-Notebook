...
- [ ] meet with nikea for microbiome enrichment (tues 9 am)
- [ ] find a sample that had double banding and run the unindexed and indexed (tues)
	- put that next to gel extracted bands
	- multiple ladders, include a middle one 
- [ ] meet with Hui (tues 2pm)
- [ ] ITS2 first PCR annealing gradient (wed)
	- 022024_BEL_CBC_T2_814_MCAV
	- 062024_BEL_CBC_T3_1433_PSTR
- [ ] ITS2 first PCR (thurs)
	- 7 samples
- [ ] think about semester achievements for lab meeting (thurs)
